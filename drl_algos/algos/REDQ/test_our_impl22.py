...
from drl_algos.algos import REDQ as REDQ
...
def create_critic():
    return critics.MlpCritic(
        hidden_sizes=CRITIC_HIDDEN, input_size=obs_dim+action_dim,
        output_size=1)
