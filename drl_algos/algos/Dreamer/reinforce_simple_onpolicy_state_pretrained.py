...
actor_critic = ActorCritic(
    model, [256, 256], horizon=5, policy_lr=0.0001, critic_lr=0.001
)
# actor_critic = ActorCritic(
...
logger = Logger2("simpleModel_smallModelPreTrained_smallActorCriticFastLR_onPolicy10Step_latentState")
...
# Pretrain the model
for i in range(200):
    _ = model.train(replay_buffer.random_batch(250, 10))
