...
logger = Logger2("simpleModel2_smallModel_smallActorCriticFastLR_onPolicy10Step_latentStateRewardDiscount")
...
for epoch in range(1, 2001):
    ...
    _, _ = model.train(replay_buffer.random_batch(2500, 1))
