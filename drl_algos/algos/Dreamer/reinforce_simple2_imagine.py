...
import drl_algos
from drl_algos.networks.mysimplemodel2 import Model, ActorCritic
...
actor_critic = ActorCritic(
    model, [64], horizon=10, policy_lr=0.0001, critic_lr=0.001
)
# actor_critic = ActorCritic(
...
logger = Logger2("simpleModel2_smallModel_smallActorCriticFastLR_imagine10Step")
...
for epoch in range(1, 2001):
    ...
    states, discounts = model.train(replay_buffer.random_batch(2500, 1))
