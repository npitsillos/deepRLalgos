...
"""
Notes:
    - Clipping didn't seem to help much but may be worth trying with a more
    accurate model and a less drastic cut-off
    - Take home is that clipping is not a substitute for an inaccurate model
"""
...
logger = Logger2("dreamer_medModel_medActorCriticNormLR_onPolicy_discountClipped")
