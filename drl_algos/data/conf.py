...
drl_algos_project_dir = join(os.path.dirname(drl_algos.__file__), os.pardir)
LOCAL_LOG_DIR = join(drl_algos_project_dir, 'experiments')
...
RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    join(drl_algos_project_dir, 'scripts', 'run_experiment_from_doodad.py')
    # '/home/user/path/to/drl_algos/scripts/run_experiment_from_doodad.py'
)
"""
AWS Settings
"""
...
SSS_RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    '/global/home/users/USERNAME/path/to/drl_algos/scripts'
...
try:
    from drl_algos.data.conf_private import *
except ImportError:
